...
const ROLLUP_DIMENSIONS = ['customer', 'campaign', 'agent', 'vendor', 'time', 'channel', 'task_type'] as const;
...
export const actualsDef: CommandDef = {
  ...
  usage: `Usage: floe actuals legs      [filters] [--cursor <c>]
       ...
       floe actuals rollups   --by <customer|campaign|agent|vendor|time|channel|task_type> [filters]
